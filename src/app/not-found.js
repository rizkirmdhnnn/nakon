      ...
      <section >
        <div className="container flex items-center min-h-screen px-6 py-12 flex-col justify-center">
          ...
          <div className="flex flex-col items-center max-w-sm mt-10 mx-auto text-center">
            <h1 className="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">Page NotFound</h1>
            <p className="mt-4 text-gray-500 dark:text-gray-400">Whoaa, your page doesnt exist</p>
            <div className="flex items-center mt-6 ">
              <Button href="/"  className=" w-auto px-5 py-2 text-sm  bg-primary rounded-lg shrink-0 ">Home</Button>
            </div>
          </div>
        </div>
      </section>
